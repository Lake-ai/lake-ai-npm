...
import "./ChatBot.css";
const ChatBot = ({ initialMessage = "Hello! How Can I Assist You ?", chatbotTitle = "Chat bot", LLM, brandImage = "https://www.kindpng.com/picc/m/179-1798038_chatbots-builder-pricing-crozdesk-free-chatbot-hd-png.png", apiKey, switchAPI = false, suggestions = [], rateLimitDuration = 5000, }) => {
